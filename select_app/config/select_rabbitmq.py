...
class SelectConsumer(object):
    ...
    def on_message(self, _unused_channel, basic_deliver, properties, body):
        ...
        #     5, lambda: self.acknowledge_message(basic_deliver.delivery_tag)
        # )
...
class SelectConsumerWrapper(object):
    def __init__(self, amqp_url):
        self._reconnect_delay = 0
        self._amqp_url = amqp_url
        self._consumer = SelectConsumer(self._amqp_url)
...
def main():
    ...
    consumer = SelectConsumerWrapper(amqp_url)
    consumer.run()
